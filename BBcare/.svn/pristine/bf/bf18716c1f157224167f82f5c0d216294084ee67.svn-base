...
<body>
	...
	<section class="ftco-section bg-light">
		<div class="container">
			...
			<div class="row" style="margin-left:12%; width:100%;">
				<div class="col-md-4 ftco-animate" style="flex: 0 0 70%; max-width: 70%;">
					<div class="block-7">
						<div class="img"
							style="background-image: url(images/pricing-3.jpg);"></div>
						<div class="text-center p-4">
							<span class="excerpt d-block">정기결제</span> <span class="price"><sup>₩</sup>
								<span class="number">3,300</span> <sub>/month</sub></span>

							<ul class="pricing-text mb-5">
								<li>월 3,300원으로</li>
								<li>편리하게 수의사와 채팅하세요!</li>
							</ul>

							<a href="payment.jsp" class="btn btn-primary" 
							style="background-color:#FFC35A; border-color:#FFC35A;">구독 결제하기</a>
						</div>
					</div>
				</div>
			</div>
