...
$(document).ready(function(){
		...
		$("#reportBtn").click(function(){
			...
			if(confirm("신고하시겠습니까?")){
				$.ajax({
					url:"adminAjax/insertReport.jsp",
					data:"userId="+userId+"&reason="+reason,
					dataType:"json",
					success:function(rs){
						var rcnt = rs.insertReport
						if(rcnt>0){
							alert("성공적으로 신고 되었습니다.")
						}else{
							alert("신고 실패")
						}
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 ftco-animate">
            <form id = "reportForm" method="POST" class="contact-form">
              <div class="form-group">
                <input type="text" class="form-control" name="userId" placeholder="피신고자 ID" value="<%= reportedUserId %>" readonly>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input id="reportBtn" type="button" value="신고하기" class="btn btn-primary py-3 px-5">
              </div>
            </form>
          </div>
        </div>
