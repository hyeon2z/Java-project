...
<br><br>
	...
	<form method="post" enctype="multipart/form-data"  action="./Board_modify_ok.jsp">
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" placeholder="제목 입력하세요"
					name="title" value="<%=data.getTitle() %>" /></td>
			</tr>
			<tr><br>
				<th>이미지</th>
				<td>
				<input type="file" placeholder="이미지를 업로드 하세요" name="img" /><br>
				<img src="./upload/<%=data.getImg() %>" width="100%">
				</td>
			</tr>
			<tr><br>
				<th>내용</th>
				<td><textarea placeholder="내용을 입력하세요"
					name="content"><%=data.getContent() %></textarea></td>
			</tr>

			<tr>
				<th><br> <!-- 등록하기 서브밋을 하면 폼이 동작하면서 값들을 전 -->
					<button type="submit" style="border-radius: 5px">수정하기</button></th>
			</tr>
