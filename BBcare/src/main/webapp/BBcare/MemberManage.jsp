...
<div class="container mt-5">
    <h2>회원 정보</h2>
     <div class="mb-3">
        <input type="text" class="form-control" id="searchField" placeholder="회원 검색">
        <button class="btn btn-info" id="schBtn" onclick="search()" type="button">Search</button>
    </div>
    <div class="table-responsive" style="overflow: hidden;">
        ...
        <div class="row mt-5" style = "margin-top: 4%; margin-bottom: 4%">
