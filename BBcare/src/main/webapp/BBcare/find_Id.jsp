...
<jsp:include page="module_top.jsp" flush="true" />
    ...
    if (email != null && !email.trim().isEmpty()) {
        Users getEmail = dao.getUserEmail(email);
        if (getEmail != null) {  
            String findIdbyEmail = getEmail.getUserId();
            out.println("<script>alert('해당 이메일의 아이디는 " + findIdbyEmail + "입니다.');</script>");
        } else {
            out.println("<script>alert('해당 이메일의 가입 정보가 없습니다.');</script>");
        }
    }
%>
	<script>
				...
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2">
						<span class="mr-2"><a href="index.jsp">Home <i
								class="ion-ios-arrow-forward"></i></a></span> <span>FindID<i
								...
								<form method="POST" id="contactForm" name="contactForm"
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												...
												<br> <label class="label" for="userId"
													style="font-size: 18px;">아이디 찾기</label> <input type="email"
										...
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												<br>
												<br> <a href="find_Pwd.jsp" style="margin-left: 70%"> <span
													id="p02">비밀번호를 잃어버리셨나요?</span>
												</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<br> <input type="submit" value="로그인"
												class="btn btn-primary" id="findIdBtn"
