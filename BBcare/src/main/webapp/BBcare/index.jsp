...
<link rel="stylesheet" href="css/jquery.timepick">
<link rel="stylesheet" href="css/style.csser.css">
...
function warning(alertCount) {
	   Swal.fire({
	       icon: 'warning',                         // Alert 타입
	       title: '주의',         // Alert 제목
	       html: '현재 '+(alertCount+1)+'회 경고 입니다.<br>경고 3회 누적 시 무통보 계정 탈퇴조치',  // Alert 내용
	   });
};

function deleteAccount(alertCount) {
    Swal.fire({
        icon: 'error',                        
        title: '탈퇴된 계정',        
        html: '회원님의 계정은 '+(alertCount+1)+'회 경고누적으로<br>계정이 탈퇴 처리 되었습니다!',
    }).then(function() {
        // OK 버튼 클릭 시
...
if (session != null) {
	...
	int alertCount = dao2.getAlertCount(userId);
    ...
    <%
	}else if(warningCount > alertCount) {
		...
		<div class="container">
			<div
				...
				<div class="col-md-11 ftco-animate text-center">
					...
					<p>
						<a href="sub.jsp" class="btn btn-primary mr-md-4 py-3 px-4">구독하기
