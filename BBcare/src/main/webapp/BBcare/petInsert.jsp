		...
		// 공백 유효성 검사
		 $("#insBtn").click(function () {
               ...
               if (errorMessages.length > 0) {
            	   ...
            	   $.ajax({
       				url: "userAjax/insertPet.jsp",
       				data: $("#contactForm").serialize(),
       				dataType: "json",
       				success: function(data) {
       					var rcnt = data.insertPet;
       					if (rcnt > 0) {
       						alert("등록성공");
       						$("#contactForm")[0].reset();
										...
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												...
												<input type="text" class="form-control" name="petName"
													placeholder="petName" id="petName" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												...
												<div style="display: flex; align-items: center;">
													<input type="text" class="form-control" name="petType"
														id="petType" placeholder="강아지,고양이.." required>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div style="display: flex; align-items: center;">
												<input type="text" class="form-control" name="breed"
													id="breed" placeholder="breed" required>
											</div>
										</div>
									</div>
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<div style="display: flex; align-items: center;">
												...
												<input type="text" class="form-control" name="imageURL" value=""
													id="imageURL" placeholder="imageURL" style="width:500px;" required>
													
													<input type="button" value="첨부하기"
													class="btn btn-primary" id="goPage"
