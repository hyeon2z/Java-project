...
// 비밀번호 찾기에 입력한 아이디 값 가져오기
String userIdbyFindId = (String) session.getAttribute("userIdbyFindId");

String password = request.getParameter("password");
String password01 = request.getParameter("password01");

if (password == null || password01 == null) {
    password = "";
    password01 = "";
} else {
    if (!password.isEmpty() && !password01.isEmpty()) {
        if (!password.equals(password01)) {
            out.println("<script>alert('비밀번호가 일치하지 않습니다.');</script>");
        } else {
            dao.updatePwd(password, userIdbyFindId);
            out.println("<script>alert('비밀번호가 수정되었습니다.');</script>");
            out.println("<script>alert('새 비밀번호로 로그인 해주세요');</script>");
            out.println("<script>location.href='index.jsp';</script>");
        }
    } else {
        out.println("<script>alert('공백없이 입력해주세요.');</script>");
    }
}
%>
	<script>
				...
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2">
						<span class="mr-2"><a href="index.jsp">Home <i
								class="ion-ios-arrow-forward"></i></a></span> <span>UpdatePassWord<i
							...
							<div style="width: 800px; margin-left: 20%">
								...
								<form method="POST" id="contactForm" name="contactForm"
										...
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												...
												<br> <label class="label" for="userId"
													style="font-size: 18px;">새 비밀번호 입력</label> <input type="password"
										...
										<div class="col-md-12">
											<div class="form-group" style="margin-left: 12px;">
												...
												<br> <label class="label" for="email"
													style="font-size: 18px;">비밀번호 재입력</label> <input type="password"
													class="form-control" name="password01" id="password01"
									...
									<div class="col-md-12">
										<div class="form-group">
											<br>
											<br> <input type="submit" value="비밀번호 설정"
												class="btn btn-primary" id="regBtn"
