...
<div class="container">
	<form id="frm01" class="form"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    <input name="ename" value="<%=ename %>" placeholder="사원명" class="form-control mr-sm-2"/>
	    <input name="job" value="<%=job %>"  placeholder="직책명" class="form-control mr-sm-2"/>
