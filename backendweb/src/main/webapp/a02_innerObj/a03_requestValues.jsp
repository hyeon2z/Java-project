...
<div class="jumbotron text-center">
  <h2 data-toggle="modal" data-target="#exampleModalCenter">물건배송</h2>

</div>
<div class="container">
		<form id="frm01" class="form" method="post">
			<div class="form-group">
				<label for="usr">물건명 등록:</label> 
			...
			<div class="form-check-inline">
				<label class="form-check-label"> 
				    <input name = "loc" type="checkbox"
					class="form-check-input" value="강원도">강원도
				</label>
			</div>
			<div class="form-check-inline">
				<label class="form-check-label"> 
				    <input name = "loc" type="checkbox"
					class="form-check-input" value="제주도">제주도
				</label>
			</div>
			<br>
