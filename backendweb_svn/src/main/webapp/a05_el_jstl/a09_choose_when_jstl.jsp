...
3. 기본 형식
	<c:choose>
		...
		<c:when test="${조건3}">
			나열된 조건을 제외하고 제건3에 해당하는 내용</c:when>
		<c:other>
			위 나열된 조건이 아닐 때.
			</c:other>
	</c:choose>		
...
<div class="container">
	<form id="frm01" class="form"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    <input placeholder="점수를 입력하세요" name="point"  class="form-control mr-sm-2" />
	    <button class="btn btn-info" type="submit">학점확인</button>
 	</nav>
	</form>
