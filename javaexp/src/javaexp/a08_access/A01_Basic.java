	...
	public static void main(String[] args) {
		...
		# 이야기1
			...
			1) 노루 나무꾼
				friendship 노루 나무꾼
					나무꾼(클래스)
					1. 노루가 숨어있는 정보 : friendship 이라는
						패키지에 있는 클래스/객체들만 접근할 수 있게 처리
						default(접근제어자가 붙지 않음) : 외부패키지에서 접근이 불가능
					
					2. 날개옷을 숨긴 곳 : private로 자신만 즉, 나무꾼 클래스만 접근해서 사용할 수 있게
