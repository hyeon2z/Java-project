	...
	public static void main(String[] args) {
		...
		Wrapper 클래스
			...
			기본데이터 유형 <==== 객체
		 			 UnBoxing포장을 풀다
		 */
//		Integer.parseInt("25") : 객체생성없이 바로 사용할 수 있는 static 메서드들이 많음
//		Integer.compare(25, 30);
		...
		Integer intob2 = 50; // AutoBoxing이 되기에 처리가 가능
		...
		Integer ob4 = numList.get(1); // 구성요소는 Integer객체로 박싱
		int num06 = ob4.intValue(); // Unboxing
		int num07 = ob4; // Auto Unboxing;
		// 위와같이 변수 선언도 생략하고 바로 할당 auto Unboxing처리
