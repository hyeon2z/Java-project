...
//		studs.get(0) = new Student("홍길동", 70, 80, 90);
		...
		System.out.println(stList.get(0));
		 /* String fruit = new String("사과") 또는 data = "사과"
			System.out.println(fruit); <- 참조변수는 클래스 내에 toString()으로 정의된 내용을 리턴한다.
			class String{
				private String str;
				String(String str){
					this.str = str;
		...
		/*
		참조변수를 호출했을 때, 특정하게 원하는 형식으로 데이터를 가져오고싶다면
		==> overriding(상위 기존 선언된 내용을 재정의)
		 */
