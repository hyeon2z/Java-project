...
public class A06_Method {
	...
	public static void main(String[] args) {
		...
		3. 메서드의 핵심기능
			메서드는 매개변수로 데이터를 받아서, 전역변수에 저장하기도
			하고, 전역변수의 데이터와 관계에 있는 로직을 처리하여
			...
			2) 구성요소 내용
				...
				매개변수
					...
					할때 식별할 수 있는 여부에 따라 동일한 메서드명
					으로도 선언이 가능하다. 이것을 메서드 오버로딩
					이라고 한다.
				
				프로세스처리
					매개변수에 데이터를 받아, 전역변수(필드)에 
					할당하거나 특정 조건/반복 처리를 하는 등
					여러가지 알고리즘 처리도 가능하다.
