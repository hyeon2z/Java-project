...
public class A02_ObjectAccess {
	...
	public static void main(String[] args) {
		...
		//                     접근제어자 붙지 않고 price를 설정하여
		// A02_ObjectAccess.java의 main()에서 호출해서 필드를
		// 사용해보고.
