...
import javaexp.z02_homework.a11_mhi.vo.Address;
import javaexp.z02_homework.a11_mhi.vo.Author;
import javaexp.z02_homework.a11_mhi.vo.Book2;
import javaexp.z02_homework.a11_mhi.vo.Customer;
import javaexp.z02_homework.a11_mhi.vo.HomeroomTeacher;
import javaexp.z02_homework.a11_mhi.vo.Member;
import javaexp.z02_homework.a11_mhi.vo.Order;
import javaexp.z02_homework.a11_mhi.vo.Person;
import javaexp.z02_homework.a11_mhi.vo.Team;
import javaexp.z02_homework.a11_mhi.vo.Student;
...
//			5) Member 객체와 Team 객체의 관계
		...
		Customer cus01 = new Customer("김만두","경기도 성남시");
		cus01.showInfo();
		cus01.setOrder(new Order("갈비만두",3000));
		cus01.showInfo();
	
		
		Student stu01 = new Student("김학생","961219");
		stu01.showInfo();
		stu01.setHomeroomTeacher(new HomeroomTeacher("김선생","5학년","3반"));
		stu01.showInfo();
		
		Person per01 = new Person("김사람",13);
		per01.showInfo();
		per01.setAddress(new Address("서울 강남구","158-81"));
		per01.showInfo();
		
		Book2 book01 = new Book2("걸어서 세계속으로","명진넷",20230301);
		book01.showInfo();
		book01.setAuthor(new Author("김작가","카카오","01012345678"));
		book01.showInfo();
	
		Member memb01 = new Member("김멤버",26);
		memb01.showInfo();
		memb01.setTeam(new Team("우리팀이 짱이다",580));
		memb01.showInfo();
...
class Customer {
    ...
    public void showOrderDetails() {
        System.out.println(name + " has ordered " + 
        order!=null?order.getProduct():"주문이 없습니다.");
    }
}
...
class Student {
    ...
    public void showTeacherName() {
        System.out.println(studentName + "'s teacher is " 
        + teacher!=null?teacher.getTeacherName():"담임교사가 배정되지 않았습니다");
    }
}
