...
public class A03_Print {
	...
	public static void main(String[] args) {
		...
		System.out.print("2) 짬뽕, ");
		System.out.print("3) 탕수육");
		/*
		# 줄바꿈과 탭간격 특수문자 처리
		1. 문자열 출력 명령문 안에서 바로 줄바꿈 처리를 할려면
			\n을 포함하여야 한다.
		2. 문자열 출력 명령문에서 탭간격으로 데이터를 출력 처리할려면
			\t를 포함하여 처리한다.
		 * */
		...
		System.out.println("1\t홍길동\t70");
		System.out.println("2\t김길동\t80");
		System.out.println("3\t신길동\t90");
		/*
		# printf("출력 format만들기", 매핑할 변수) 
		형식을 선언후, 해당 형식안에 들어갈 데이터를 처리하는 형식
		 * */
		String name = "홍길동";
		int age = 25;
		double salary = 5000.5134;
		System.out.printf("이름: %5s%n",name);
