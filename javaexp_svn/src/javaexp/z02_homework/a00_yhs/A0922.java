...
//
//		**[1단계:개념] 9.** 
//		연산자는 값(피연산자)에 대한 작업을 수행하는 기호입니다. 
		//`5 + 3`에서 `+`는 연산자이며, `5`와 `3`은 피연산자입니다.
		// 전체 `5 + 3`은 연산식입니다.
//
//		**[1단계:개념] 10.** 
//		산술 연산자는 수학적 연산을 수행하는 연산자입니다.
		//예: `+`, `-`, `*`, `/`, `%` (나머지 연산자). `%` 연산자는 나눗셈 후의 나머지를 반환합니다. 예를 들어, `7 % 3`은 1을 반환합니다.		
//		**[1단계:코드] 11.** 
//		```java
...
//
//		**[1단계:개념] 13.** 
//		증감대입연산자는 변수의 값을 증가하거나 감소시키는 연산자입니다. 
		// 예: `+=`, `-=`, `*=`, `/=`, `%=`.
//
//		```java
//		int y = 10;
...
//
//		**[1단계:개념] 25.** 
//		지역변수는 특정 영역(블록) 내에서만 사용되는 변수이며, 
		// 그 영역을 벗어나면 사용할 수 없습니다. 
		// for문 내의 변수 i는 지역변수입니다.
//   전역변수는 클래스 레벨에서 선언되는 변수로 클래스 내의 모든 메서드에서 접근 가능합니다.
//
//		**[1단계:개념] 26.** 
//		전역변수는 for문 안과 밖에서 모두 접근할 수 있으므로 
		// for문에서 전역변수의 값을 변경하면, 
// 		 for문 이후에도 그 변경된 값을 사용할 수 있습니다.
//
//		**[1단계:코드] 27.**
//		```java
//		import java.util.Scanner;
...
//
//		**[1단계:개념] 44.** 
//		생성자는 객체가 생성될 때 자동으로 호출되어 객체의 초기화를 담당하는
		 // 특별한 메서드입니다. 일반 메서드는 객체의 행위나 동작을 정의하며,
		 // 원하는 시점에 호출하여 사용할 수 있습니다.
//
//		**[1단계:개념] 45.** 
...
//
//		**[1단계:개념] 46.** 
//		생성자는 객체가 생성될 때 한 번만 호출되며, 초기화 작업을 주로 담당합니다. 
		 // 일반 메서드는 객체가 생성된 이후에 필요할 때마다 여러 번 호출될 수 있습니다. 
