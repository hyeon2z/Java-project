...
//     - 필드: (이름), (종류, 나이), 체중, 색상
      Animal animal1 = new Animal("뽀리","폼피츠");
      Animal animal2 = new Animal(3,4.7);
      Animal animal3 = new Animal("흰색");
      System.out.println("\n# 동물 정보 #\n이름:" + animal1);
      System.out.println("종류:" + animal1.kind);
      System.out.println("나이:" + animal2.age+"살");
      System.out.println("체중:" + animal2.weight+"kg");
      System.out.println("색상:" + animal3.color);
...
class Music {
   ...
   Music(String song, String artist) {
      this.song = song;
      this.artist = artist;
   }
