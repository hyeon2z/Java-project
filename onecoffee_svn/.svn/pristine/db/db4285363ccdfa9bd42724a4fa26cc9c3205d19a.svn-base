                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p style = "margin-top:40px">이름</p>
                                <input value = "<%=mem.getName()%>" type="text" name = "name" readonly style="cursor: auto;">
                                </div>
                            <div class="checkout__input">
                                <p>아이디</p>
                                <input value = "<%=mem.getId()%>"type="text" name = "id" readonly style="cursor: auto;">
                            </div>
                            <div class="checkout__input">
                                <p>비밀번호</p>
                            ...
                            <div class="checkout__input">
                                <p>포인트</p>
                                <input value = "<%=mem.getPoint()%>" name = "point" type="text"  readonly style="cursor: auto;">
                            </div>
