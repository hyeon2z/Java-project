                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p style = "margin-top:40px">이름<span style="margin-left: 5px">(수정불가)</span></p>
                                <input value = "<%=mem.getName()%>" type="text" name = "name" readonly style="cursor: auto; background-color: #f1f3f5;">
                                </div>
                            <div class="checkout__input">
                            ...
                            <div class="checkout__input">
                                <p>전화번호</p>
                                <input value = "<%=mem.getPhonenum()%>" name = "phone"type="text"  readonly style="cursor: auto;">
                            	<input name = "changePhoneNum" type="text" placeholder="수정할 전화번호 입력">
                            </div>
                            <div class="checkout__input">
                                <p>주소</p>
                                <input value = "<%=mem.getAddress()%>" name = "address" type="text"  readonly style="cursor: auto;">
                            	<input name = "changeAddress" type="text" placeholder="수정할 주소 입력">
                            </div>
                            <button type="submit" class="site-btn">개인정보 수정</button>
                        </div>
