...
<script>
	...
	function boardDetail(boardNum, boardTitle) {
		location.href = 'readBoard.jsp?boardNum=' + boardNum + '&title=' + boardTitle
	}
</script>
</head>
<body>
	...
	<header class="header">
		...
		<div style="text-align: center; padding-top: 30px;padding-bottom: 30px;">
			<input type="button" onclick="writeBoard()" value="공지 등록"
