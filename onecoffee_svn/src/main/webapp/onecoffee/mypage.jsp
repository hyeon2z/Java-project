...
<head>
	...
	<style>
		.mypageMenu a:hover {
		    color: blue; /* 마우스를 올렸을 때 텍스트 색상 변경 */
		}
		...
		.mypageMenu a::after {
		    ...
		    width: 100%;
		    height: 2px;
		    background-color: red; /* 밑줄 색상 변경 */
		    display: none;
		}
		
		.mypageMenu a:hover::after {
		    display: block; /* 마우스를 올렸을 때 밑줄 표시 */
		}
	</style>
<body>
    <!-- Page Preloder -->
                ...
                <form action="#" method = "post">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <h6 class="checkout__title">마이페이지</h6>
                            <h6 class="checkout__title" style = font-size:15px;>            
                            	<a href="#user-info" class ="mypageMenu" style = "color:black; margin-right:5%;">개인 정보</a>
					            <a href="#order-history" class ="mypageMenu" style = "color:black; margin-right:5%;">주문 내역</a>
					            <a href="#points-coupons" class ="mypageMenu" style = "color:black; margin-right:5%;">포인트 및 쿠폰</a>
					            <a href="#settings-notifications" class ="mypageMenu" style = "color:black; margin-right:5%;">설정 및 알림</a>
					            <a href="#withdraw" class ="mypageMenu" style = "color:black; margin-right:5%;">회원 탈퇴</a>
					        </h6>

                            <div class="checkout__input">
                                <p style = "margin-top:40px">이름<span>*</span></p>
