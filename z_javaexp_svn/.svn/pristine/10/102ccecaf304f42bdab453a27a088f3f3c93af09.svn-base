...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		2. 즉, heap영역에 실제 객체의 메모리를 사용하고, stack영역
			...
			가지고 있고, 실제 이 위치정보를 찾아가면 도서관에 특정한 
