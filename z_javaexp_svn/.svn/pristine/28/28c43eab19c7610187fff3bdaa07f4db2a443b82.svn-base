...
public class A09_StaticMember {
	...
	public static void main(String[] args) {
		...
		1. 객체에서 한번 할당하면 변경할 수 있는 내용을 상수라고 한다.
			객체별 상수..
		2. static 상수 : 객체들의 공유 메모리이기 클래스에 한번 할당되면
			변경되지 않는 수를 말한다. 일반적을 자바에서 상수는 이 static
			상수를 의미하고 주로 대문자로 사용한다. ex) Math.PI
		 * */
		// static 변수는 객체 생성하지 않더라도 사용할 수 있다.
		Member01.no2++;
		Member01.no2++;
		Member01.no2++;
...
//		m1.no3 = 5; 객체별로 상수를 할당할 수 있다.
		//Member03.NO04 = 15;
		System.out.println("static final 상수:"+
				Member03.NO04);
		// 객체 생성없이 바로 사용가능 하다.
...
class Member04{
	...
	int no2;
	static void call() {
		System.out.println("스태틱 메서드(객체 생성없이사용)");
		System.out.println("스태택 변수 사용:"+(++no));
