	...
	public static void main(String[] args) {
		...
		2. 반복문
			...
			2) 
			   ...
			   String menu="";
			   while(!menu.equals("Q")){ // Q 입력시 반복 종료
					반복수행할 block
			...
			4) 그외 반복문에서 사용할 주요 키워드(if문과 함께 사용)
				...
				for(int cnt=1;cnt<=10;cnt++){
					if(cnt==5){
						...
						않고 다음 step(6)으로 넘거가겠습니다. 
					}
					if(cnt==8){
						break;
						반복문 수행을 모두 중단 처리 더 이상 중괄호
						블럭내에 있는 구문 수행하지 않음. 
						반복 step이 남아 있더라도
					}
		...
		System.out.println("순차구조 처리:"+(++no));
		// ex) int cnt = 0;
		//     @@번째 안녕하세요를 출력하되, 3의 배수인 경우에
		//     짝!! 3의 배수입니다라고 출력되게 조건문 처리하세요..
		int cnt=0;
		System.out.println(++cnt+"번째 안녕하세요");
		...
		System.out.println(++cnt+"번째 안녕하세요");if(cnt%3==0) System.out.println("짝!! 3의 배수입니다!");
		System.out.println(++cnt+"번째 안녕하세요");if(cnt%3==0) System.out.println("짝!! 3의 배수입니다!");
		System.out.println(++cnt+"번째 안녕하세요");if(cnt%3==0) System.out.println("짝!! 3의 배수입니다!");
		System.out.println(++cnt+"번째 안녕하세요");if(cnt%3==0) System.out.println("짝!! 3의 배수입니다!");
		System.out.println(++cnt+"번째 안녕하세요");if(cnt%3==0) System.out.println("짝!! 3의 배수입니다!");
