	...
	public static void main(String[] args) {
	    ...
	    3. 특정 문자열을 찾을 때, 활용되는 indexOf()
	    	1) 기본형식
	    		...
	    		리턴해준다. 해당 문자열을 포함하지 않으면 -1을 리턴한다.
	    	ex) 키워드 검색시 주로 활용된다. 포함된 문자열의 시작위치를
	    		리턴한다.
	     * */
	    ...
	    System.out.println("판매물건 리스트:"+ menu);
	    System.out.print("구매할 물건 입력:");
