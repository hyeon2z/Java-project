...
public class A07_for_if {
	...
	public static void main(String[] args) {
		...
		// ex2) 1~100중 3과 5의 공배수(3의 배수 그리고 5의 배수)
		// 		출력 하기
		...
		System.out.println("#1000을 초과하는 최초의 숫자#");
		...
		System.out.println("첫번째로 합산이 1000을 넘은 숫자:"+
				(!isFirst?"없음":first1000));
		// ex4) 1~100까지 숫자 중에 7로 나누었을 때 4인 숫자 출력
		System.out.println("#7로 나누었을 때 4인 숫자 출력#");
		for(int cnt = 1;cnt<=100;cnt++) {
			if(cnt%7==4) {
				System.out.print(cnt+",");
			}
		}		
		// ex5) 10부터 50까지 숫자중에 13으로 나누었을 때 떨어지는
		//      첫번째 숫자 출력..
		int chFirst = 0;
